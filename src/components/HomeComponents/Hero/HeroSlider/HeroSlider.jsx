          ...
          >
            <SwiperSlide>
              <div className="bg-gray-50 ">
                <img src="/images/banner/hero-instance-4--desktop.png" alt="" />
                ...
                <div className="absolute right-0 sm:right-10 bottom-0 bg-base-100/95 shadow-lg rounded-lg sm:p-4 p-2">
                  ...
                  <div className="text-center text-neutral mt-2">
                    ...
                    <h6 className="text-sm text-neutral/90">Frankie Albion</h6>
            ...
            <SwiperSlide>
              <div className="bg-gray-50 ">
                <img src="/images/banner/hero-instance-2--desktop.png" alt="" />
            ...
            <SwiperSlide>
              <div className="bg-gray-50">
                <img src="/images/banner/hero-instance-1--desktop.png" alt="" />
